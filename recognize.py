...
classifier = cv2.CascadeClassifier(r'C:/Users/monik/OneDrive/Desktop/face detections/haarcascade_frontalface_default.xml')

model = load_model(r"C:/Users/monik/OneDrive/Desktop/face detections/final_model.h5")

URL = 'http://192.0.0.4:8080/shot.jpg'

def get_pred_label(pred):
    labels = ['hritik', 'mona', 'puja']
    return labels[pred]
